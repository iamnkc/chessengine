...
GameBoard.pieces = new Array(BRD_SQ_NUM); //pieces on game board
GameBoard.side = COLOURS.WHITE; //player turn
GameBoard.fiftyMove =0; //fifty move rule
GameBoard.hisPly = 0;  //half move
GameBoard.ply =0;  //dont know
GameBoard.history = []; //History array
GameBoard.enPas = 0; // enpassant
GameBoard.castlePerm =0; //castling permission 
GameBoard.material = new Array(2); //
GameBoard.pceNum = new Array(13); //numbers of piece types on the board
GameBoard.pList = new Array(14*10); // Pieces available on board
GameBoard.posKey =0 ; //represents unique number 
